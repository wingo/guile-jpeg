...
(define-exif-tags *exif-tag-names*
  ...
  (#x8828 optoelectric-conversion-factor)
  ...
  (#x9203 brightness)
  (#x9204 exposure-bias)
  (#x9205 maximum-lens-aperture)
  (#x9206 subject-distance)
  (#x9207 metering-mode)
  (#x9208 light-source)
  (#x9209 flash)
  (#x920a lens-focal-length)
  (#x9214 subject-area)
  (#xa20b flash-energy)
    ...
    (let lp ((n 0))
      (if (< n tag-count)
          (cons (let* ((pos (+ pos 2 (* n 12)))
                       ...
                       (value* (interpret-value name value)))
                  (cons name value*))
                (lp (1+ n)))
          '())))
